...
Provider titles, URLs, snippets, ranks, and bounded metadata are discovery material, not Source content or Evidence. A selected candidate must pass the restricted web-reader and immutable Source processing pipeline before it can become Ready or support retrieval. This decision adds neither general browser automation nor general Agent Web access.
