...
var toolNameValues = []string{"search_evidence", "discover_sources", "inspect_source", "web_search", "current_time", "save_url_as_source", "configured_delegation", "read_tool_result"}
